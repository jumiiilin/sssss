...
st.write("### df_sales 샘플 데이터")
st.write(df_sales.head())

st.write("### df_subway 샘플 데이터")
...
def calculate_total_traffic(df_grouped):
    ...
    st.write("### 승차 데이터 샘플")
    st.write(df_board.head())
    st.write("### 하차 데이터 샘플")
    st.write(df_alight.head())
